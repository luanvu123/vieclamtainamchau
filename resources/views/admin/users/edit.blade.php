            ...
            <form action="{{ route('users.update', $user->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="col-xs-2 col-sm-2 col-md-2">
                    <div class="form-group">
                        ...
                        <input type="color" name="favorite_color" value="{{ $user->favorite_color }}" class="form-control">
                    </div>
                </div>
                ...
                <div class="col-xs-2 col-sm-2 col-md-2">
                    <div class="form-group">
                        ...
                        <input type="text" name="language" value="{{ $user->language }}" class="form-control" placeholder="Language">
                    </div>
                </div>
                ...
                <div class="col-xs-2 col-sm-2 col-md-2">
                    <div class="form-group">
                        ...
                        <input type="text" name="google" value="{{ $user->google }}" class="form-control" placeholder="Google">
                    </div>
                </div>
                ...
                <div class="col-xs-2 col-sm-2 col-md-2">
                    <div class="form-group">
                        ...
                        <input type="text" name="skype" value="{{ $user->skype }}" class="form-control" placeholder="Skype">
                    </div>
                </div>
                ...
                <div class="col-xs-2 col-sm-2 col-md-2">
                    <div class="form-group">
                        ...
                        <input type="text" name="slack" value="{{ $user->slack }}" class="form-control" placeholder="Slack">
                    </div>
                </div>
                ...
                <div class="col-xs-2 col-sm-2 col-md-2">
                    <div class="form-group">
                        ...
                        <input type="text" name="instagram" value="{{ $user->instagram }}" class="form-control" placeholder="Instagram">
                    </div>
                </div>
