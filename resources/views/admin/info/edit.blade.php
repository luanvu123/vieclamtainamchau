...
<div class="container">
    ...
    <form action="{{ route('info.update') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <input type="number" name="number_job_seeker_1" id="number_job_seeker_1" class="form-control" value="{{ $info->number_job_seeker_1 ?? 0 }}">
        </div>

        <div class="form-group">
            <label for="number_job_seeker_2">Hotline hỗ trợ kỹ thuật cho người tìm việc:</label>
            <input type="number" name="number_job_seeker_2" id="number_job_seeker_2" class="form-control" value="{{ $info->number_job_seeker_2 ?? 0 }}">
        </div>

        <div class="form-group">
            <label for="number_employer_1">Hotline cho Nhà tuyển dụng</label>
            <input type="number" name="number_employer_1" id="number_employer_1" class="form-control" value="{{ $info->number_employer_1 ?? 0 }}">
        </div>

        <div class="form-group">
            <label for="number_employer_2">Hotline hỗ trợ kỹ thuật Nhà Tuyển Dụng</label>
            <input type="number" name="number_employer_2" id="number_employer_2" class="form-control" value="{{ $info->number_employer_2 ?? 0 }}">
        </div>
