                                ...
                                @foreach ($jobPostings as $job)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <div><i class="fas fa-calendar-alt"></i> Hạn:
                                                {{ \Carbon\Carbon::parse($job->closing_date)->format('d/m/Y') }}</div>
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <div class="btn-group" role="group">
                                                ...
                                                <a href="{{ route('employer.admin.job-postings.edit', ['employerId' => $job->employer->id, 'jobPostingId' => $job->id]) }}"
                                                    class="btn btn-warning btn-sm" title="Chỉnh sửa">
                                                    <i class="fas fa-edit"></i>
                                                </a>
                                                <button type="button" class="btn btn-danger btn-sm" data-bs-toggle="modal"
                                                    data-bs-target="#deleteJobModal{{ $job->id }}" title="Xóa">
