        ...
        <form action="{{ route('employer.job-posting.update', $jobPosting->id) }}" method="POST">
            ...
            <div class="mb-3">
                ...
                <select id="type" name="type" class="form-select" required>
                    <option value="fulltime" {{ $jobPosting->type == 'fulltime' ? 'selected' : '' }}>Fulltime</option>
                    <option value="parttime" {{ $jobPosting->type == 'parttime' ? 'selected' : '' }}>Parttime</option>
            ...
            <div class="mb-3">
                ...
                <select id="experience" name="experience" class="form-control">
                    ...
                    <option value="1 năm" {{ $jobPosting->experience == '1 năm' ? 'selected' : '' }}>1 năm</option>
                    <option value="2 năm" {{ $jobPosting->experience == '2 năm' ? 'selected' : '' }}>2 năm</option>
                    <option value="3 năm" {{ $jobPosting->experience == '3 năm' ? 'selected' : '' }}>3 năm</option>
                    <option value="4 năm" {{ $jobPosting->experience == '4 năm' ? 'selected' : '' }}>4 năm</option>
                    <option value="5 năm" {{ $jobPosting->experience == '5 năm' ? 'selected' : '' }}>5 năm</option>
                    <option value="5+ năm" {{ $jobPosting->experience == '5+ năm' ? 'selected' : '' }}>5+ năm</option>
                </select>
                @error('experience')
                    <span class="text-danger">{{ $message }}</span>
            ...
            <div class="mb-3">
                ...
                <select id="rank" name="rank" class="form-control">
                    <option value="Nhân viên" {{ $jobPosting->rank == 'Nhân viên' ? 'selected' : '' }}>Nhân viên</option>
                    <option value="Thực tập sinh" {{ $jobPosting->rank == 'Thực tập sinh' ? 'selected' : '' }}>
                        Thực tập sinh</option>
                    <option value="Quản lý" {{ $jobPosting->rank == 'Quản lý' ? 'selected' : '' }}>Quản lý</option>
