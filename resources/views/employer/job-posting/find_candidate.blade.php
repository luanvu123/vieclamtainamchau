                                        ...
                                        <div class="modal-body">
                                            ...
                                            <p><strong>LinkedIn:</strong>
                                                @if ($candidate->linkedin)
                                                    <a href="{{ $candidate->linkedin }}"
                                                        target="_blank">{{ $candidate->linkedin }}</a>
                                                @else
                                                    Không có
                                                @endif
                                            </p>
                                            <div class="form-group">
                                                ...
                                                @if ($candidate->cv_path)
                                                    <div class="mb-3">
                                                        ...
                                                        <iframe src="{{ asset('storage/cvs/' . $candidate->cv_path) }}"
                                                            width="100%" height="500px" frameborder="0">
                                                            <!-- Nếu trình duyệt không hỗ trợ iframe, có thể cung cấp một liên kết tải xuống -->
                                                            <a href="{{ asset('storage/cvs/' . $candidate->cv_path) }}"
                                            ...
                                            <p><strong>Thư giới thiệu:</strong>
                                                @if ($candidate->letter_path)
                                                    <a href="{{ asset('storage/' . $candidate->letter_path) }}"
